...
export const Profile = () => {
    const loggedInUser = useResources('/api/getLoggedInUser')
    console.log(loggedInUser?.first_name);
                                ...
                                <div className='col-md-6 mt-5'>
                                    ...
                                    <Form onSubmit={handleSubmit} encType='multipart/form-data'>
                                        ...
                                        <Form.Group className="mb-3 mt-1" controlId="middlename">
                                            ...
                                            <Form.Control type="text"
                                                defaultValue={loggedInUser?.middle_name}
                                        ...
                                        <Form.Group className="mb-3 mt-1" controlId="username">
                                            ...
                                            <Form.Control type="text"
                                                defaultValue={loggedInUser?.user_name}
                                        ...
                                        <Form.Group className="mb-4 mt-3" controlId="formMobileNumber">
                                            ...
                                            <Form.Control type="number"
                                                defaultValue={loggedInUser?.mobile_number}
                                        ...
                                        <Form.Group className="mb-4 mt-3" controlId="gender">
                                            ...
                                            <Form.Select defaultValue={loggedInUser?.gender} onChange={e => setGender(e.target.value)} >
                                        ...
                                        <Form.Group className="mb-4 mt-3" controlId="blood-group">
                                            ...
                                            <Form.Select defaultValue={loggedInUser?.blood_group} onChange={e => setBloodGroup(e.target.value)}>
